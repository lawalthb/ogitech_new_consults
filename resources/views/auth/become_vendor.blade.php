                        ...
                        <div class="row">
                                    ...
                                    <div class="padding_eight_all bg-white">
                                        ...
                                        <form method="POST" action="{{ route('vendor.register') }}">
                                            ...
                                            <div class="form-group">
                                                <input type="text" id="name" required="" name="name" placeholder="FullName   e.g: Mr. John Don" />
                                            </div>
                            ...
                            <div class="col-lg-6 pr-30 d-none d-lg-block">
                                <div class="card-login mt-115">
                                    <img class="border-radius-15" src="{{ asset('frontend/assets/imgs/page/about-1.png') }}" alt="" />
                                </div>
                            </div>
                        </div>
                    </div>
