...
<div class="page-content">
    ...
    <div class="ps-3">
      <nav aria-label="breadcrumb">
        <ol class="breadcrumb mb-0 p-0">
          ...
          <li class="breadcrumb-item active" aria-current="page">Online Payment Report</li>
        </ol>
      </nav>
    </div>
  ...
  <div class="row row-cols-1 row-cols-md-1 row-cols-lg-3 row-cols-xl-3">
    ...
    <form method="post" action="{{ route('search_payment-by-date')}}">
      @csrf
    ...
    <form method="post" action="{{ route('search_payment-by-month')}}">
      @csrf
    ...
    <form method="post" action="{{ route('search_payment-by-year')}}">
      @csrf
      <div class="col">
        <div class="card">
