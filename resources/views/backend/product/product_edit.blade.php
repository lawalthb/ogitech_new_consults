							...
							<div class="border border-3 p-4 rounded">
								<div class="row g-3">
									...
									<div class="form-group col-md-6">
										...
										<input type="text" name="purchase_price" class="form-control" id="inputPrice" value="{{ $products->purchase_price }}">
									</div>
									<div class="col-md-6">
										<label for="inputCompareatprice" class="form-label">Selling Price </label>
										<input type="text" name="selling_price" class="form-control" id="inputCompareatprice" value="{{ $products->selling_price }}">
									</div>
									<div class="form-group col-md-6">
										<label for="inputCostPerPrice" class="form-label">Product Code</label>
										<input type="text" name="product_code" readonly class="form-control" id="inputCostPerPrice" value="{{ $products->product_code }}">
									</div>
									<div class="form-group col-md-6">
										<label for="inputStarPoints" class="form-label">Unit</label>
										<input type="text" name="unit" class="form-control" id="inputStarPoints" value="{{ $products->unit }}">
									</div>
