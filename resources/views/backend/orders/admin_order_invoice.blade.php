...
<body>
  ...
  <table width="100%" style="background: #F7F7F7; padding:0 20px 0 20px;">
    <tr>
      <td valign="top">
        ...
        <h2 style="color: green; font-size: 26px;"><strong>BookShop</strong></h2>
      </td>
      <td align="right">
        <pre class="font">
             OGITECH Consults
               Email:support@ogitechconsults.ng <br>
  ...
  <table width="100%" style=" padding:0 10px 0 10px;">
    <tr>
      <td align="right">
        <h2><span style="color: green;">Subtotal:</span>NGN{{ $order->amount }}</h2>
        <h2><span style="color: green;">Total:</span> NGN{{ number_format( $order->amount) }}</h2>
