...
<div class="page-content">
  ...
  <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
    <div class="breadcrumb-title pe-3">Make Payment</div>
    <div class="ps-3">
      <nav aria-label="breadcrumb">
        <ol class="breadcrumb mb-0 p-0">
          <li class="breadcrumb-item"><a href="javascript:;"><i class="bx bx-home-alt"></i></a>
          </li>
          <li class="breadcrumb-item active" aria-current="page">Widthraw / Expense</li>
        </ol>
      </nav>
    </div>
    <div class="ms-auto">
            ...
            <div class="card-body">
              ...
              <form method="post" action="{{ route('admin.payment.store') }}">
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-9 text-secondary">
                    <input type="number" name="amount_out" class="form-control" placeholder="Enter Amount" require />
                  </div>
                </div>
                <div class="row mb-3">
                  <div class="col-sm-3">
...
<script>
  $(document).ready(function() {
    ...
    $('#searchInput').on('keyup', function() {
      var searchText = $(this).val().toLowerCase(); // Get the user's input and convert it to lowercase
      $('#selectOptions option').each(function() {
        var optionText = $(this).text().toLowerCase(); // Get the text of each option and convert it to lowercase
        // Check if the option text contains the search text
        if (optionText.includes(searchText)) {
          $(this).show(); // Show the option if it matches the search text
        } else {
          $(this).hide(); // Hide the option if it does not match the search text
        }
      });
    });
  });
