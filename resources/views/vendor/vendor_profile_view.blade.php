						...
						<div class="card-body">
							...
							<ul class="list-group list-group-flush">
								<li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
									...
									<span class="text-secondary">https://ogitechconsults.ng</span>
								</li>
								...
								<li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
									...
									<span class="text-secondary">ogitechconsults</span>
								</li>
							</ul>
						</div>
					</div>
					...
					<div class="card">
						<div class="card-body">
							...
							<form method="post" action="{{ route('vendor.profile.store') }}" enctype="multipart/form-data">
								...
								<div class="row mb-3">
									<div class="col-sm-3">
										<h6 class="mb-0">Vendor Department </h6>
									</div>
									<div class="col-sm-9 text-secondary">
										<select name="vendor_department" class="form-select mb-3" aria-label="Default select example">
											...
											<option value="{{$department->id}}" {{ $vendorData->vendor_department == $department->id  ? 'selected' : '' }}>{{$department->category_name}}</option>
