...
<div class="sidebar-wrapper" data-simplebar="true">
	<div class="sidebar-header">
		...
		<div>
			<h4 class="logo-text">O.G ~ Vendor</h4>
		</div>
	...
	<ul class="metismenu" id="menu">
		...
		<li>
			...
			<ul>
				<li> <a href="{{ route('vendor.statement', $id) }}"><i class="bx bx-right-arrow-alt"></i>Statement</a>
				</li>

				<li> <a href="{{ route('vendor.all.product') }}"><i class="bx bx-right-arrow-alt"></i>Stock</a>
				</li>
