              ...
              <div class="tab-pane fade active show" id="dashboard" role="tabpanel" aria-labelledby="dashboard-tab">
                <div class="card">
                  <div class="card-header">
                    <h3 class="mb-0">Orders that are with me</h3>
                  </div>
                  <div class="card-body">
                      ...
                      <table class="table" style="background:#ddd;font-weight: 600;">
                        <thead>
                          <tr>
                            ...
                            <th>Department</th>
                            <th>Level</th>
                            <th title="BookShop Status">B.Staus</th>
                            <th title="HOC Status">H.Staus</th>
                            <th>Action</th>
                          </tr>
                        </thead>
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td> {{ $order->user->matno }}</td>
                            <td> {{ $order->user->name }}</td>
                            <td> {{ $order->category->category_name }}</td>
                            <td> {{ $order->user->level }}</td>
                            <td>
                            ...
                            <td>
                              ...
                              <a href="{{ url('user/order_given/'.$order->id) }}" class="btn-sm btn-success"><i class="fa fa-check"> Given</i></a>
                              @endif
                            </td>
                          </tr>
                          @endforeach
                  ...
                  <div class="card">
                    <div class="card-header">
                      <h3 class="mb-0">Orders that i have given out</h3>
                    </div>
                    <div class="card-body">
                      <div class="table-responsive">
                        <table class="table" style="background:#ddd;font-weight: 600;">
