    ...
    <div class="row">
        ...
        <div class="clearfix product-price-cover">
            ...
            <div class="product-price primary-color float-left">
                <span class="current-price text-brand">₦{{ number_format($product->selling_price )}}</span>

            </div>
            @else

            <div class="product-price primary-color float-left">
                <span class="current-price text-brand">₦{{ number_format($product->discount_price) }}</span>
                <span>
                    <span class="save-price font-md color3 ml-15">{{ round($discount) }}% Off</span>
                    <span class="old-price font-md ml-15">₦{{ number_format($product->selling_price) }}</span>
                </span>
            </div>
        ...
        <div class="attr-detail attr-size mb-30">
            <strong class="mr-10" style="width:50px;">Size/Type: </strong>
        ...
        <div class="font-xs">
            <ul class="mr-50 float-start">
                <li class="mb-5">Type: <span class="text-brand">{{ $product['brand']['brand_name'] }}</span></li>
                ...
                <div class="product-cart-wrap hover-up">
                    <div class="product-img-action-wrap">
                        ...
                        <div class="product-action-1">
                            ...
                            <!-- <a aria-label="Compare" class="action-btn small hover-up" href="shop-compare.html" tabindex="0"><i class="fi-rs-shuffle"></i> -->
                        </div>
