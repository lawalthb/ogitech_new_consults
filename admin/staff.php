					...
					<div class="container-fluid">
						...
						<div class="box box-block bg-white">
							...
							<table class="table table-striped table-bordered dataTable" id="table-2">
								...
								<tbody>
                                <?php 
								$sql = "SELECT a.*, u.* from users_type as u, auth as a where a.user_type_id =u.user_type_id and status = 1 ";
								...
								if ($result->num_rows > 0) 
								{
									...
									<tr>
                                        ...
                                        <a class="btn btn-danger btn-sm" href="staff.php?s=<?php echo $row['auth_id'];?>" title="Delete"><i class="ti-trash mr-0-5"></i><?php echo $lang['Delete'];?></a><?php }  ?>
                                        </td>
									</tr>
                                  <?php $i++; }
								} ?>																	
