...
die('<script>alert("Invalid link")</script>');
            ...
            <div class="box box-block bg-white">
              <h5 class="mb-1">Exporting Incomes <?php  if(!empty($_SESSION['user_type_id']) &&( $_SESSION['user_type_id']!='2' and $_SESSION['user_type_id']!='4'))  { ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp; &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;
              <?php }
                if($_GET['ac_type']==7  ){ ?>
...
?>
              ...
              <table class="table table-striped table-bordered" id="table-2">
                ...
                <tbody>
                 ...
                 $sql = "SELECT c.*, inv.* FROM ledger_entries as inv, documents as c where c.documnents_id=inv.documents_id and inv.sub_acct_group_id = 7 and c.document_type=31  ORDER BY `inv`.`id` DESC";
