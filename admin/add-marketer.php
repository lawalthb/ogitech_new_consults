						...
						<div class="box box-block bg-white">
							...
							<form class="form-material material-primary" id="addcategory">
								<div class="form-group row">
									<label for="inputEmail3" class="col-sm-2 col-form-label">Marketer</label>
									<div class="col-sm-10">
										<input type="text" class="form-control" id="cat_name" name="cat_name" placeholder="Marketer/Agent" autocomplete="off" required>
									</div>
								</div>    
                                ...
                                <div class="form-group row">
									<div class="offset-sm-2 col-sm-10">
										<button type="submit" class="btn btn-primary" id="btn-submit" value="Add Marketer" >Add Marketer</button>                                     
			   ...
			   function submitForm()
				{
					...
					$.ajax({
						...
						type : 'POST',
						url  : 'modal/add_marketerModel.php',
						data : data,
						dataType : 'json',
