...
//	$document_type= $ac_type.$inv_type ;
	$invoice_sql = "INSERT INTO `documents` (`documnents_id`, `document_date`, `document_no`, `document_comments`, `lpo_grn`, `document_type`, `inserted_at`, `auth_id`, `updated_at`, `updated_by`) VALUES (NULL, '$datepicker_invoice_exp', '$receipt_no', '$details', '', '$ac_type', CURRENT_TIMESTAMP, '$auth_id', CURRENT_TIMESTAMP, '0')";  
	$invoice_sqlq=$conn->query($invoice_sql);
	 ...
	 VALUES ('$invoice_last_id', '$paid2ru' , 0, '$amount_in', '$particular' , '$act_type_id', '$act_grp_id')";  
...
//supplier
	 ...
	 VALUES ('$invoice_last_id', '$particular' , '$amount_in', 0, '$paid2ru' ,  '$act_type_id2', '$act_grp_id2')";  
