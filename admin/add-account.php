						...
						<div class="box box-block bg-white">
							...
							<form class="form-material material-primary" id="addcategory">
								<div class="form-group row">
									<label for="inputEmail3" class="col-sm-2 col-form-label">Name Of Sub Account</label>
									<div class="col-sm-10">
                                ...
                                <div class="form-group row">
									<label for="inputEmail3" class="col-sm-2 col-form-label">Account Purpose</label>
									<div class="col-sm-10">
										<input type="text" class="form-control" id="code" name="code" placeholder="Optional" autocomplete="off">
									</div>
                                </div>  
                                ...
                                <div class="form-group row">
									...
									<div class="col-sm-10">
                                    <?php 
								$w = "SELECT * FROM acct_group_tb WHERE `status` != 0";
								$resultw = $conn->query($w); ?>
                                    ...
                                    <select id="acct_grp" name="acct_grp"  class="form-control" data-plugin="select2" required>
											...
											<option value="<?php echo $roww['acct_group_id'];?>"><?php echo strtoupper($roww['names']);?></option>
										<?php } ?>
										</select>
									</div>
								</div>                                
