...
<head>
		...
		<link rel="stylesheet" href="../adaptinvdentory/font-awesome/css/font-awesome.min.css">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="table-responsive" style="margin-top: 10px">
                            <table class="table table-bordered table-hover" id="normalinvoice">
								...
								$resultc = $conn->query($c); $rowd = $resultc->fetch_assoc() ?>
										<select id="paid2ru" name="paid2ru" class="form-control" data-plugin="select2" required>
                                        <option selected value="<?php echo $rowd['bank_code']; ?>"><?php echo $rowd['bank_number']; ?> -
										 <?php echo $rowd['bank_name']; ?></option>
										...
										<option value="303">Cash in Hand</option>
										 ...
										 <span><a href="add-account3.php">New</a></span>
                                        ...
                                        <td >
										<input type="text" required autocomplete="off" name="particular" class="customerSelection form-control" placeholder='paid by?' id="customer_name" required  />
			   ...
			   function submitForm()
				{
					...
					$.ajax({
						...
						type : 'POST',
						url  : 'modal/add_receiptModel.php',
						data : data,
						dataType : 'json',
