...
<head>
		...
		<!-- Title -->
		<title>Add Purchase Expense Voucher</title>
			...
			<div class="site-content">
				...
				<div class="content-area py-1">
					<div class="container-fluid">
						<h4>Adding Purchase Expenses</h4>
                    ...
                    <div class="panel-body">
                        <div class="row">                        
							<div class="col-sm-8">
                                ...
                                <?php 
									...
									$last_no = "SELECT * FROM `documents` where document_type=91 ORDER BY `documnents_id` DESC  ";
                        ...
                        <div class="table-responsive" style="margin-top: 10px">
                            <table class="table table-bordered table-hover" id="normalinvoice">
                                <thead>
                                    <tr>
                                        <th class="text-center">Select Supplier<i class="text-danger">* </i>(Debiting) </th>                                        
...
<?php } ?>	
								...
								$resultc = $conn->query($c); ?>
                                        ...
                                        <option value="307">1017317112 - Zenith - 1015009879</option>
                                        <?php while($rowc = $resultc->fetch_assoc()) { ?>
											<option value="<?php echo $rowc['cus_id'];?>"><?php echo $rowc['cus_name'];?></option>
										<?php } ?>	
										</select>
