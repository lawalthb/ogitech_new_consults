			...
			<div class="site-content">
				...
				<div class="content-area py-1">
					<div class="container-fluid">
						<h4>Adding Debit or credit Note</h4>
						<ol class="breadcrumb no-bg mb-1">
							<li class="breadcrumb-item"><a href="index.php"><?php echo $lang['Dashboard'];?></a></li>							
							<li class="breadcrumb-item active"> Debit or credit Note</li>
						</ol>                       
                        ...
                        <div class="row">                        
							<div class="col-sm-8">
                                ...
                                <?php 
									...
									$last_no = "SELECT * FROM `documents` where document_type=61 ORDER BY `documnents_id` DESC  ";
                            ...
                            <table class="table table-bordered table-hover" id="normalinvoice">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-center">Select Particular <i class="text-danger">* </i>(Transfer To) Credit </th>
                                ...
                                <tbody id="add_row_to_invoice">
                                    <tr>
                                    <td >
										<input type="text" required autocomplete="off" name="paid2ru" class="customerSelection form-control" placeholder='Minus?' id="customer_name" required  />

<input id="customer_id" class="hidden_value" type="hidden" name="paid2ru">  
...
<?php } ?>	
                                        ...
                                        <td >
										<input type="text" required autocomplete="off" name="particular" class="customerSelection form-control" placeholder='Plus' id="customer_name" required  />
