...
die('<script>alert("Invalid link")</script>');
                 ...
                 ?>
                             ...
                             <div class="col-sm-8" >
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                       <input type="hidden" size="100" autocomplete="off"   value="1003"   name="lpo_no" class="form-control" placeholder='Optional' id="lpo_no"   />
        ...
        if($_GET['ac_type']==1 ){
                           ?>
                           <script src="js/invoice45.js"></script>
                   <?php
               ...
               function submitForm()
                {
                    ...
                    $.ajax({
                        ...
                        type : 'POST',
                        url  : 'modal/add_invoiceModel_po.php',
                        data : data,
                        dataType : 'json',
                            ...
                            else if(data.status==='successfully')
                            {
                                 ...
                                 // $("#addinvoice").trigger('reset');
                                  ...
                                  if(x==1){
                                    ...
                                    setTimeout('$("#addinvoice").fadeOut(500, function(){ window.location = "qoutation-lpos.php?ac_type=1" }); ',1000);
                                  }else if(x==2){

                                      setTimeout('$("#addinvoice").fadeOut(500, function(){ window.location = "qoutation-lpos.php?ac_type=2" }); ',1000);
                                    }
