				...
				<div class="content-area py-1">
					<div class="container-fluid">
						...
						<ol class="breadcrumb no-bg mb-1">
                            ...
                            <li class="breadcrumb-item active">Inter Trnsfer</li>
                            <li class="breadcrumb-item"><a href="intertransfers.php">List</a></li>
						</ol>                       
                        ...
                        <div id="error"></div>                       
							<div class="col-sm-8" id="customer_section_1">
                                <div class="form-group row">
                                    <label for="customer_name" class="col-sm-3 col-form-label">Transfer No. <i class="text-danger">*</i></label>
                                    
                                    <div class="col-sm-6">
                                   <?php     $last_no = "SELECT * FROM `transfer_tb` ORDER BY `order_id` DESC ";
                                $result_last_no = $conn->query($last_no);
                                $row_last_no = $result_last_no->fetch_assoc();
                                $lastvno = $row_last_no['order_id']+1;   ?>
                            ...
                            <table class="table table-bordered table-hover" id="normalinvoice">
                                ...
                                <tbody id="addinvoiceItem">
                                    <tr>
                                        ...
                                        <td style="width: 85px">
                                            <input name="product_rate[]"   onkeyup="quantity_calculate(1)" onchange="quantity_calculate(1);" value="" id="item_price_1" class="item_price_1 price_item form-control" tabindex="7"   required type="text">
                                        </td>
                                        <!-- Discount -->
                                        <td>
                                            
                                            <select name="discount[]" id="discount_1" class="form-control" value="" autocomplete="off" min="0" tabindex="4" onkeyup="quantity_calculate(1);" onchange="quantity_calculate(1);">
                                ...
                                <tfoot>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-right">
                                            <input id="paidAmount" autocomplete="off" class="form-control" readonly="" name="paid_amount"  value="" placeholder="0.00" tabindex="7" type="text">
                                        </td>
                                    </tr>
                                    <tr>
                                        <td align="center" colspan="2">
			   ...
			   function submitForm()
				{
					...
					$.ajax({
						...
						type : 'POST',
						url  : 'modal/add_transferModel.php',
						data : data,
						dataType : 'json',
						...
						{					
							...
							else if(data.status==='successfully')
							{
									...
									setTimeout('$("#addinvoice").fadeOut(500, function(){ window.location = "intertransfers.php" }); ',1000);
