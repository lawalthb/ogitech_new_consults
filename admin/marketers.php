...
if(isset($_GET['c']) && !empty($_GET['c'])){
	...
	$del = "DELETE FROM marketer_tb WHERE marketer_id='$c'";
	if ($conn->query($del) === TRUE) {
		header("location: marketers.php?d=del");		
	} else {
		header("location: marketers.php?d=n");		
	}
}
?>
<!DOCTYPE html>
				...
				<div class="content-area py-1">
					<div class="container-fluid">
						...
						<ol class="breadcrumb no-bg mb-1">
							...
							<li class="breadcrumb-item active">Marketer List</li>
						</ol>
						<div class="box box-block bg-white">
							<h5 class="mb-1">Export Marketers</h5>
							<table class="table table-striped table-bordered dataTable" id="table-2">
								...
								{	
									...
									<tr>
                                        ...
                                        <a class="btn btn-secondary btn-sm" href="edit-marketers.php?c=<?php echo $row['marketer_id'];?>" title="Edit"><i class="ti-pencil mr-0-5"></i><?php echo $lang['Edit'];?></a> 
                                        <a class="btn btn-danger btn-sm" href="JAVASCRIPT:onclick=Delete(<?php echo $row['marketer_id'];?>)"  title="Delete"><i class="ti-trash mr-0-5"></i><?php echo $lang['Delete'];?></a>
                                        <?php } ?>
                                        </td>
									</tr>
                                  <?php $i++; }
