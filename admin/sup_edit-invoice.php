...
if(isset($_GET['i']) && !empty($_GET['i'])){
	...
	$sql = "SELECT c.*,o.*,inv.*, ipd.* FROM sup_invoice_payment_detail as ipd, sup_orders as o,sup_invoices as inv, suppliers as c where c.supplier_id=ipd.customer_id
	and c.supplier_id=o.customer_id and ipd.customer_id=o.customer_id and ipd.invoice_no_id=inv.invoice_number and o.order_id=ipd.order_id and o.order_id='$getorder_id'";
		...
		if ($result->num_rows > 0) 
		{
			while($row = $result->fetch_assoc()) 
			{
				...
				$cus_name=$row['supplier_name'];
				$cus_mobile=$row['supplier_phone'];
				$cus_address=$row['supplier_address'];
                        ...
                        <div class="table-responsive" style="margin-top: 10px">
							...
							and pli.order_id=$getorder_id and pli.invoice_no_id=$invoice_number";
                                ...
                                <tfoot>
                                    ...
                                    <tr>
                                        <td align="center">
                                            <input id="add-invoice" class="btn btn-success" name="add-invoice" disabled value="<?php echo $lang['Submit'];?>" tabindex="8" type="submit">                                            
                                        </td>                                
