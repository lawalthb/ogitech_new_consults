...
<head>
		...
		<!-- Title -->
		<title>Add petty Expense Voucher</title>
			...
			<div class="site-content">
				...
				<div class="content-area py-1">
					<div class="container-fluid">
						<h4>Adding Petty  Expenses</h4>
						<ol class="breadcrumb no-bg mb-1">
							<li class="breadcrumb-item"><a href="index.php"><?php echo $lang['Dashboard'];?></a></li>							
							<li class="breadcrumb-item active"> Petty Payment Voucher </li>
						</ol>                       
                    ...
                    <div class="panel-body">
                        <div class="row">                        
							<div class="col-sm-8">
                                ...
                                <?php 
									...
									$last_no = "SELECT * FROM `documents` where document_type=51 ORDER BY `documnents_id` DESC  ";
                                ...
                                <div class="form-group row">
									<label for="expense_type_id" class="col-sm-3 form-control-label">Payment Voucher No.:<i class="text-danger">*</i></label>
									<div class="col-sm-6">
                        ...
                        <div class="table-responsive" style="margin-top: 10px">
                            <table class="table table-bordered table-hover" id="normalinvoice">
                                <thead>
                                    <tr>
                                        <th class="text-center">Select Particular<i class="text-danger">* </i>(Debiting) </th>                                        
                                        
                                        <th class="text-center">Amount Paid <i class="text-danger">*</i>(out) </th>                                        
                                        <th class="text-center">Paid Through <i class="text-danger">* </i>(Crediting)</th>
                                ...
                                <tbody id="add_row_to_invoice">
                                    <tr>
										...
										<input type="text" required autocomplete="off" name="particular" class="customerSelection form-control" placeholder='paid to?' id="customer_name" required  />

<input id="customer_id" class="hidden_value" type="hidden" name="particular">
...
<?php } ?>	
</select> --> <span><a href="add-account3.php">New</a></span>
								...
								$resultc = $conn->query($c); ?>
                                        ...
                                        <option value="303">Cash at hand</option>
                                        <?php while($rowc = $resultc->fetch_assoc()) { ?>
											<option value="<?php echo $rowc['cus_id'];?>"><?php echo $rowc['cus_name'];?></option>
										<?php } ?>	
										</select>
