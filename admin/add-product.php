                        ...
                        <div id="error"></div>
                            ...
                            <div id="#error" ></div>
                                ...
                                <div class="form-group row">
									...
									<div class="col-sm-10">
										<input type="text" class="form-control" id="product_name" name="product_name" placeholder="Product Name / Service Name" autocomplete="off" required>
									</div>
								</div>
                                <?php 
                                ...
                                <div class="form-group row">
									...
									<div class="col-sm-10">
										...
										<?php } ?>	
										</select> <a href="add-category.php">[New]</a>
									</div>
								</div>
                                <?php 
                                ...
                                <div class="form-group row">
									<label for="warehouse_id" class="col-sm-2 form-control-label">To_Location </label>
									<div class="col-sm-10">
                             ...
                             <div class="row">
                                ...
                                <table class="table table-bordered mb-0">
										<thead>
											<tr>
												<th><?php echo $lang['Quantity'];?> Available <i class="text-danger">*</i></th>
												<th><?php echo $lang['SellPrice'];?> <i class="text-danger">*</i></th>
												<th><?php echo $lang['SupplierPrice'];?> <i class="text-danger">*</i></th>
												<th>Item Owner <i class="text-danger">*</i></th>
                                                <th>Unit <i class="text-danger">*</i></th>
												<th><?php echo $lang['Suppliers'];?>/From Location <i class="text-danger">*</i></th>
										...
										<tbody>
											<tr>
                                                ...
                                                <div class="form-group row">                                               
                                                <div class="col-sm-10">
                                                <input type="text" class="form-control" id="product_qty" name="product_qty" value="0.00" autocomplete="off" required>
                                                </div>
                                           		 </div>
                                          		</td>
												<td>
                                                ...
                                                <option value="bdls">Bundles</option>
