...
<head>
	...
	<body class="fixed-sidebar fixed-header skin-3 content-appear">
			...
			<div class="site-content">
				...
				<form class="form-vertical" id="addinvoice" name="addinvoice" enctype="multipart/form-data" method="post" accept-charset="utf-8">
                    <div class="panel-body">
                        ...
                        <div id="error"></div>  
							...
							<div class="col-sm-8" >
                                ...
                                <div class="form-group row">
                                    <label for="customer_name" class="col-sm-3 col-form-label">LPO No. <i class="text-danger">*</i></label>
                                    
                                    <div class="col-sm-6">
                                       <input type="text" size="100" autocomplete="off"  autofocus name="paper_inv_no" class="form-control" placeholder='Enter Invoice Number' id="paper_inv_no" required  />
                            ...
                            <div class="col-sm-8" id="customer_section_1">
                                ...
                                <div class="form-group row">
                                    <label for="customer_name" class="col-sm-3 col-form-label">Supplier Name <i class="text-danger">*</i></label>
                                    
                                    <div class="col-sm-6">
                                       <input type="text" size="100" autocomplete="off" name="customer_name" class="customerSelection form-control" placeholder='Enter Supplier name' id="customer_name" required  />

                                        <input id="customer_id" class="hidden_value" type="hidden" name="customer_id">
                                    </div>
                                    <div  class=" col-sm-3">
                                        <input id="oldcustomer_1" type="button" onClick="active_customer('customer_section_1')"  class="btn btn-success checkbox_account" name="customer_confirm" checked="checked" value="New Supplier" ><br>
                            ...
                            <div class="col-sm-8" id="customer_section_2">
                               <div class="form-group row">
                                    <label for="customer_name_others" class="col-sm-3 col-form-label">Supplier Name <i class="text-danger">*</i></label>
                                    <div class="col-sm-6">
                                       <input  autocomplete="off" type="text"  size="100" name="new_customer" placeholder='Supplier Name' id="new_customer" class="form-control" required />
                                    </div>
                                    <div  class="col-sm-3">
                                        <input  onClick="active_customer('customer_section_2')" type="button" id="oldcustomer_2" class="checkbox_account btn btn-success" name="new_customer_name" value="Old Supplier">
                                    </div>
                                </div>
                                <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    <label for="customer_name_others_address" class="col-sm-3 col-form-label">Contact Person </label>
                                    <div class="col-sm-6">
                                    <input type="text"  size="100" name="contact_person" autocomplete="off" class=" form-control" placeholder='contact person'   />
                        ...
                        <div class="form-group row">
                            <label for="datepicker_invoice_date" class="col-sm-2 col-form-label">LPO Type <i class="text-danger">*</i></label>
                            <div class="col-sm-4">
                                
                                <select class="form-control"  required  id="po-type" name="po-type" >
                        ...
                        <div class="form-group row">
                            <label for="datepicker_invoice_date" class="col-sm-2 col-form-label">Date Due <i class="text-danger">*</i></label>
                            <div class="col-sm-4">
                                
                               <input type="text" class="form-control" autocomplete="off" required  id="datepicker_invoice_date2" name="date-due" placeholder="yyyy-mm-dd">
                        ...
                        <div class="form-group row">
                            <label for="datepicker_invoice_date" class="col-sm-2 col-form-label">Mode/Terms Of Payment</label>
                            <div class="col-sm-4">
                                
                               <input type="text" class="form-control" autocomplete="off" required  name="payment-mode" >
                                
                           </div>
                        </div> 
                        
                        <div class="form-group row">
                            <label for="datepicker_invoice_date" class="col-sm-2 col-form-label">Terms Of Delivery</label>
                            <div class="col-sm-4">
                                
                               <input type="text" class="form-control" autocomplete="off" value="Immediately" required  name="deleivery-term" >
                            ...
                            <table class="table table-bordered table-hover" id="normalinvoice">
                                ...
                                <tbody id="addinvoiceItem">
                                    <tr>
                                        <td style="width: 220px">
                                            <input name="product_name[]"  class="form-control productSelection" placeholder="<?php echo $lang['Products'];?>" required id="product_name" autocomplete="off" tabindex="1" type="text">
                                           <input type="hidden" class="autocomplete_hidden_value product_id_1" name="product_id[]" id="product_id"/>
                                        </td>
                                        
                                        <td>
                                            <input name="discription[]" class="form-control discription" value=""  type="text">
                                        </td>
                                        <td>
                                        ...
                                        <td style="width: 85px">
                                            <input name="product_rate[]" onkeyup="quantity_calculate(1)" onchange="quantity_calculate(1);" value="" id="item_price_1" class="item_price_1 price_item form-control" tabindex="7" ng-model="rte" required type="text">
                                        </td>
                                        <!-- Discount -->
                                        <td>
                                            ...
                                            <option value="kg">Kg</option>
                                       		...
                                       		<input type="hidden" id="discount_1" value="0" class="form-control"  />
                                ...
                                <tfoot>
                                    ...
                                    <tr>
                                        ...
                                        <input id="total_discount_ammount" type="hidden" class="form-control" name="total_discount" tabindex="-1" value="0.00"  type="text">
                                            <input id="grandTotal" class="form-control"  name="grand_total_price" value="0.00" tabindex="-1"  type="text">
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td style="text-align:right;" colspan="4"><b>VAT on Purchase(5%):</b></td>
                                        <td class="text-right">
                                            <input id="paidAmount" autocomplete="off" class="form-control" name="paid_amount" readonly  value="" placeholder="0.00" tabindex="7" type="text">
                                        </td>
                                    </tr>
                                    <tr>
                                        <td align="center" colspan="2">
                                            <input id="add-invoice" class="btn btn-success" name="add-invoice"  value="<?php echo $lang['Submit'];?>" tabindex="9" type="submit">
                                            <input  class="btn btn-warning" name=""  value="Reset" tabindex="8" type="reset">
                                        </td>                                
        ...
        <script src="js/lpo-invoice.js"></script>      
        <script>
	...
	$(document).ready(function(){
		$('#datepicker_invoice_date2').datepicker({
		format: "yyyy-mm-dd",
		autoclose: true,
		todayHighlight: true
		});		
...
<?php include ('supplier.js.php'); ?>
<?php include ('product_supplieir.js.php'); ?>        
					...
					$.ajax({
						...
						{					
							...
							else if(data.status==='successfully')
							{
									...
									setTimeout('$("#addinvoice").fadeOut(500, function(){ window.location = "sup_invoice.php" }); ',1000);
