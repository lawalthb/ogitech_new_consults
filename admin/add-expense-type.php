							...
							<form class="form-material material-primary" id="addexptype">
                                ...
                                <div class="form-group row">
									<div class="offset-sm-2 col-sm-10">
										<button type="submit" class="btn btn-primary" id="btn-submit" value="Add Category" ><?php echo $lang['AddExpenseType'];?></button>  <a href="javascript:history.go(-1)" title="Return to the previous page">&laquo; Go back</a>                                   
					...
					$.ajax({
						...
						//alert(data.status);
							...
							else if(data.status==='successfully')
							{
									...
									$("#btn-submit").html('Add Expense type');									
									toastr.options = {
