                        ...
                        <div id="error"></div> 
                            ...
                            <div class="col-sm-8">
                                ...
                                <div class="form-group row">
                                    <label for="customer_name" class="col-sm-3 col-form-label">GRN No. <i class="text-danger">*</i></label>
                                    
                                    <div class="col-sm-6">
                                       <input type="text" size="100" autocomplete="off" onkeyup="chk_inv2(this.value)"   autofocus name="grn_no" class="form-control" placeholder='Enter Invoice Number' id="grn_no" required  />

                                        
                                    </div>
                                    <div  class=" col-sm-3" id="chk_result2">
                            ...
                            <div class="col-sm-8">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                       <input type="text" size="100" autocomplete="off" onkeyup="chk_inv(this.value)"    name="paper_inv_no" class="form-control" placeholder='Enter Invoice Number' id="paper_inv_no" required  />
                            ...
                            <div class="col-sm-8" id="customer_section_1">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div  class=" col-sm-3">
                                        <input id="oldcustomer_1" type="button" onClick="active_customer('customer_section_1')"  class="btn btn-success checkbox_account" name="customer_confirm" checked="checked" value="New Supplier" >
                                    </div>
                                </div>                                
                            </div>
                            ...
                            <table class="table table-bordered table-hover" id="normalinvoice">
                                ...
                                <tbody id="addinvoiceItem">
                                    <tr>
                                        ...
                                        <!-- Discount -->
                                        <td>
                                            <input name="discount[]" id="discount_1" class="form-control" value="" autocomplete="off" min="0" tabindex="4"  placeholder="if any comment" onkeyup="quantity_calculate(1);" onchange="quantity_calculate(1);" placeholder="0.00" type="text">
                                ...
                                <tfoot>
                                    <tr >
                                        <td colspan="4" align="right" ><input style="text-align:right" type="text" name="in_words" id="amount-rupees" readonly id="word" value="" size="80"></td>
                                        <td class="text-right">
                                    ...
                                    <tr>
                                        ...
                                        <td style="text-align:right;" colspan="4"><b>VAT on Sales (5%):</b></td>
                                        <td class="text-right">
                                    ...
                                    <tr>
                                        <td align="center" colspan="2">
                                            ...
                                            <input id="full_paid_tab" class="btn btn-warning" name="" onclick="full_paid();" value="Reset" tabindex="8" type="reset">
                                        </td>                                
               ...
               function submitForm()
                {
                    ...
                    $.ajax({
                        ...
                        type : 'POST',
                        url  : 'modal/add_sup_invoiceModel.php',
                        data : data,
                        dataType : 'json',
...
function chk_inv(str){
  ...
  if (str.length == 0) {
    ...
    xmlhttp.open("GET", "chk_inv.php?e=" + str, true);
    xmlhttp.send();
  }
}
...
<script>
function chk_inv2(str){
        
  if (str.length == 0) {
    document.getElementById("chk_result2").innerHTML= "You can't leave it blank";
    return;
  } else {
    var xmlhttp = new XMLHttpRequest();
    xmlhttp.onreadystatechange = function() {
      if (this.readyState == 4 && this.status == 200) {
        document.getElementById("chk_result2").innerHTML = this.responseText;
      }
    };
    xmlhttp.open("GET", "chk_inv.php?g=" + str, true);
    xmlhttp.send();
  }
}
