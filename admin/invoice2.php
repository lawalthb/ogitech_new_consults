			...
			<div class="site-content">
				...
				<div class="content-area py-1">
					<div class="container-fluid">
						...
						</ol><center><a href="invoice.php?i=<?=$_GET['i']?>">[Without VAT]</a>   &nbsp; <a href="invoice2.php?i=<?=$_GET['i']?>">[With VAT]</a></center>
						<div class="card" id="printinvoice">
							<div class="card-header clearfix">
								<h5 class="float-xs-left mb-0"><?php echo $lang['Invoice'];?> #<?php if(isset($invoice_number)){
							...
							<div class="card-block" >
								<div class="row mb-6">
									...
									<img src="img/logo/<?php if(isset($setting_logo)) echo $setting_logo;?>" width="150" height="150">
                                        ...
                                        <strong>TIN No.: 20189237-0001 </strong>
										</div>
                                    ...
                                    <h5><?php echo $lang['InvoiceTo'];?>:</h5>
										...
										<?php if($act_grp_id !=2){ ?>
										 <p contentEditable="true">LPO: <?php if(isset($lpo_grn)){echo $lpo_grn;}?></p>
									 <?php }else{  ?>
								 ...
								 <?php	} ?>
									 ...
									 <p contentEditable="true"><?php echo $lang['Phone'];?>: <?php if(isset($cus_mobile)){echo $cus_mobile;}?></p>
									 <p contentEditable="true">Email: <?php if(isset($email)){echo $email;}?></p>
								...
								if ($queryresult->num_rows > 0)
								{
									...
									?>
										<tr>
											...
											<td><?php if(isset($setting_currency)){ echo $setting_currency;}?><?php
                                            $vrate= (($productrow['product_rate']/107.5)*100);
                                            $vtotal = $productrow['product_quantity']*$vrate;
                                            $v_sum_total = $v_sum_total +$vtotal  ;
                                             echo number_format($vrate, 2, '.', ',');?></td>

                                            <td id="grandTotal2"><?php if(isset($setting_currency)){ echo $setting_currency;}?><?php echo number_format($vtotal, 2, '.', ',');?></td>
                                    ...
                                    <thead>
                                        ...
                                        <th class="text-center right" style="text-align: right;"><em>VAT on Sales</em></th>
                                        <th class="text-center"></th>
                                        <th class="text-center"></th>
                                        <th class="text-center">7.5%</th>

                                        <th class="text-center">
                                            <?=number_format($grand_total_price - $v_sum_total, 2, '.', ',') ?></th>
                                    </tr>
                                    <tr>
                                        <th class="text-center"></th>
                                        <th class="text-center"></th>
...
<hr class="hr">
                                        ...
                                        <h5>Bank Details:</h5>
                                        <?php 
								$sql = "SELECT *  FROM `banks_tb` WHERE `display_inv` = 1 and bank_status =1" ;
								$result = $conn->query($sql);
								...
								{	
									...
									{ ?>
                                        <div class="clearfix mb-0-25">
                                            <span class="float-xs-left">Account No <?=$i++?>:  <?php echo $row['bank_number'];?> - <?php echo $row['bank_name'];?></span>
                                        </div>

                                        <div class="clearfix mb-0-25">
                                            <span class="float-xs-left">Account Name: <b><?php echo $row['bank_display_name'];?></b></span>
