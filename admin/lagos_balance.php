...
$html.= "<html><head><title>".$dtd."-All customers balance</title>
...
<br /><b>All customers</b><br /> Balance <br />
As at ". Date('j - F - o')."
 </center>";
...
Dr.     <span style=\"color:red\">Cr.</span>
                                ...
                                <tbody>
                               "; 
                                $sql = "SELECT * FROM `customers` WHERE `ac_type` NOT LIKE 'income' ORDER BY `cus_name` ASC ";
