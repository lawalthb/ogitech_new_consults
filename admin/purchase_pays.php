...
//die();
  if ($conn->query($del) === TRUE) {
    ...
    header("location: purchase_pays.php?d=del&ac_type=9&showall=1");   
   }else{
    header("location: purchase_pays.php?d=n&ac_type=10&showall=1");   
  }
}
?>
<!DOCTYPE html>
...
<head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
    ...
    <title><?php
    if($_GET['ac_type']==9 ){
                            echo 'Purchase Expenses';
                    }elseif($_GET['ac_type']==10 ){

                          echo 'Other  Expenses ';
                    }else{echo  "Petty Expenses";}
                    ?></title>
            ...
            - 
                   <?php
                    if($_GET['ac_type']==9  ){
                          ...
                          echo 'For Others ';
                    }elseif($_GET['ac_type']==5){ echo  "For Petty"; }else{
die('<script>alert("Invalid link")</script>');
            ...
            <ol class="breadcrumb no-bg mb-1">
              ...
              <li class="breadcrumb-item active"><?php  if($_GET['ac_type']==9  ){
                  if(!isset($_GET['showall'])){  ?>
                <a href="purchase_pays.php?ac_type=9&showall=1" >Purchase and Others Expenses List</a>
              <?php }else{?>
                <a href="purchase_pays.php?ac_type=9" >Purchase Expenses</a><?php
                } }elseif($_GET['ac_type']==10){
                  if(!isset($_GET['showall'])){  ?>
                    <a href="purchase_pays.php?ac_type=9&showall=1" >Purchase and Others Expenses List</a>
                  <?php }else{?>
                    <a href="purchase_pays.php?ac_type=5" >Petty Expenses</a><?php
                    }}elseif($_GET['ac_type']==5 ){  ?>
                        <a href="purchase_pays.php?ac_type=5&showall=1" >Petty Expenses List</a>
                      <?php }?>
            ...
            <div class="box box-block bg-white">
              <h5 class="mb-1">Exporting Expenses <?php  if(!empty($_SESSION['user_type_id']) &&( $_SESSION['user_type_id']!='2' and $_SESSION['user_type_id']!='4'))  { ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp; &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;
              <?php }
                if($_GET['ac_type']==9  ){ ?>
                  <input  type="button"  class="btn btn-success checkbox_account" onClick="JAVASCRIPT:window.location ='purchase_payment.php?ac_type=9&inv_type=1'")  name="customer_confirm"  value="New Purchase Expenses" >
<?php
                    }elseif($_GET['ac_type']==10 ){
?>
                        <input  type="button"  class="btn btn-success checkbox_account" onClick="JAVASCRIPT:window.location ='purchase_payment.php?ac_type=9&inv_type=1'")  name="customer_confirm"  value="Add Other Expenses" >
                   <?php }elseif($_GET['ac_type']==5 ){
?>
                        <input  type="button"  class="btn btn-success checkbox_account" onClick="JAVASCRIPT:window.location ='petty_payment.php?ac_type=5&inv_type=1'")  name="customer_confirm"  value="Add Petty Expenses" >
                   <?php }
                 ?></h5>
              ...
              <table class="table table-striped table-bordered" id="table-2">
                <thead>
                  <tr>
                    ...
                    if($_GET['ac_type']!=5 ){  ?>
                    <th>Customer</th>
                    <?php }else{ echo  "<th>Particular</th>";} ?></th>
                ...
                <tbody>
                 ...
                 $sql = "SELECT c.*, inv.* FROM ledger_entries as inv, documents as c where c.documnents_id=inv.documents_id and inv.sub_acct_group_id =2  ORDER BY `inv`.`id` DESC";
                                  ...
                                  $sql = "SELECT c.*, inv.* FROM ledger_entries as inv, documents as c where c.documnents_id=inv.documents_id and inv.sub_acct_group_id =2 and c.document_type=91  ORDER BY `inv`.`id` DESC";
                                }
          ...
          $sql = "SELECT c.*, inv.* FROM ledger_entries as inv, documents as c where c.documnents_id=inv.documents_id and inv.sub_acct_group_id = 2  and c.document_date BETWEEN '$_POST[start]' AND '$_POST[end]' ORDER BY `inv`.`id` DESC";
                                     ...
                                     $sql = "SELECT c.*, inv.* FROM ledger_entries as inv, documents as c where c.documnents_id=inv.documents_id  and c.document_type=51 ORDER BY `inv`.`id` DESC";
                                                    }elseif(!isset($_GET['showall'])){
                                                      $sql = "SELECT c.*, inv.* FROM ledger_entries as inv, documents as c where c.documnents_id=inv.documents_id  and c.document_type=51 and  inv.sub_acct_group_id != 7 ORDER BY `inv`.`id` DESC";
                                                    }
                    
                                                    if(isset($_POST['start']) and isset($_POST['end'])){
                                                      $sql = "SELECT c.*, inv.* FROM ledger_entries as inv, documents as c where c.documnents_id=inv.documents_id  and  inv.sub_acct_group_id != 7 and c.document_type=51  and c.document_date BETWEEN '$_POST[start]' AND '$_POST[end]' ORDER BY `inv`.`id` DESC";
                                            }}
