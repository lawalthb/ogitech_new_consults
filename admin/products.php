							...
							<table class="table table-striped table-bordered dataTable" id="table-2">
								...
								if ($result->num_rows > 0) 
								{
									...
									<tr>
                                        ...
                                        <a class="btn btn-danger btn-sm" href="JAVASCRIPT:onclick=Delete(<?php echo $row['product_id'];?>)" title="Delete"><i class="ti-trash mr-0-5"></i><?php echo $lang['Delete'];?></a>
                                       <?php } ?>
                                        </td>
									</tr>
                                  <?php $i++; }
...
function Delete(x) {
	//alert(x);
  var txt;
  if (confirm("Are you sure you want to delete this Prduct!")) {
   window.location.href = "products.php?p="+x;
  } else {
