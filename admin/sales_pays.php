...
//die();
  if ($conn->query($del) === TRUE) {
    ...
    header("location: sales_pays.php?d=del&ac_type=7&showall=1");   
   }else{
    header("location: sales_pays.php?d=n&ac_type=7&showall=1");   
  }
}
?>
<!DOCTYPE html>
...
die('<script>alert("Invalid link")</script>');
            ...
            <ol class="breadcrumb no-bg mb-1">
              ...
              <li class="breadcrumb-item active"><?php  if($_GET['ac_type']==7  ){
                  if(!isset($_GET['showall'])){  ?>
                <a href="sales_pays.php?ac_type=7&showall=1" >Sales and Others Income List</a>
              <?php }else{?>
                <a href="sales_pays.php?ac_type=7" >Sales Income</a><?php
                } }elseif($_GET['ac_type']==8){
                  if(!isset($_GET['showall'])){  ?>
                    <a href="invoices.php?ac_type=7&showall=1" >Sales and Others Income List</a>
                  <?php }else{?>
                    <a href="invoices.php?ac_type=8" >Other Incomes</a><?php
                    } 
            ...
            <div class="box box-block bg-white">
              <h5 class="mb-1">Exporting Incomes <?php  if(!empty($_SESSION['user_type_id']) &&( $_SESSION['user_type_id']!='2' and $_SESSION['user_type_id']!='4' and $_SESSION['user_type_id']!='3'))  { ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp; &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;
              <?php }
                if($_GET['ac_type']==7 and $_SESSION['user_type_id']!='3'  ){ ?>
                  <input  type="button"  class="btn btn-success checkbox_account" onClick="JAVASCRIPT:window.location ='sales-payment.php'")  name="customer_confirm"  value="New Sale Income" >
<?php
                    }elseif($_GET['ac_type']==8 ){
?>
                        <input  type="button"  class="btn btn-success checkbox_account" onClick="JAVASCRIPT:window.location ='sales-payment.php?ac_type=8&inv_type=1'")  name="customer_confirm"  value="Add Other Income" >
                   <?php }
                 ?></h5>
              ...
              <table class="table table-striped table-bordered" id="table-2">
                ...
                <tbody>
                  ...
                  $sql = "SELECT c.*, inv.* FROM ledger_entries as inv, documents as c where c.documnents_id=inv.documents_id and inv.sub_acct_group_id = 7 and c.document_type=31 and c.`document_date` BETWEEN '$op_st' AND '$op_en'  ORDER BY `inv`.`id` DESC";
                                }elseif(!isset($_GET['showall'])){
                                  $sql = "SELECT c.*, inv.* FROM ledger_entries as inv, documents as c where c.documnents_id=inv.documents_id and inv.sub_acct_group_id = 1 and c.document_type=31  ORDER BY `inv`.`id` DESC";
                                }

                                if(isset($_POST['start']) and isset($_POST['end'])){
                                  $sql = "SELECT c.*, inv.* FROM ledger_entries as inv, documents as c where c.documnents_id=inv.documents_id and inv.sub_acct_group_id = 7 and c.document_type=31  and c.document_date BETWEEN '$_POST[start]' AND '$_POST[end]' ORDER BY `inv`.`id` DESC";
                        }}elseif($_GET['ac_type']==8 ){
                                                if(isset($_GET['showall'])){
                  ...
                  <tr>
                    ...
                    <td><a class="btn btn-success btn-sm" href="invoice.php?i=<?php echo $row['documnents_id'];?>" title="View"><i class="ti-eye mr-0-5"></i><?php echo $lang['View'];?></a> 
                                       <?php  if(!empty($_SESSION['user_type_id']) &&( $_SESSION['user_type_id']!='2' and $_SESSION['user_type_id']!='4'  and $_SESSION['user_type_id']!='3'))  { ?>
										...
										<a class="btn btn-secondary btn-sm" href="edit_sales-payment.php?sales_income_edit=<?php echo $row['documents_id'];?>" title="Edit"><i class="ti-pencil mr-0-5"></i><?php echo $lang['Edit'];?></a> 
...
function Delete(x,y,p) {
 //alert(x);
  ...
  if (confirm("Are you sure you want to delete ")) {
   window.location.href = "sales_pays.php?i="+x+"&ac_type="+y+"&p="+p;
  } else {
