				...
				<div class="content-area py-1">
					<div class="container-fluid">
						...
						<div class="box box-block bg-white">
							...
							<div class="pull-right"><input  type="button"  class="btn btn-success checkbox_account" 
							onClick="JAVASCRIPT:window.location ='add-category.php'") 
							 name="customer_confirm"  value="Add New Category" >
							</div>
							<table class="table table-striped table-bordered dataTable" id="table-2">
								...
								{	
									...
									<tr>
                                        ...
                                        <a class="btn btn-danger btn-sm" href="JAVASCRIPT:onclick=Delete(<?php echo $row['cat_id'];?>)" title="Delete"><i class="ti-trash mr-0-5"></i><?php echo $lang['Delete'];?></a>
                                        <?php } ?>
                                        </td>
									</tr>
                                  <?php $i++; }
...
function Delete(x) {
  ...
  if (confirm("Are you sure you want to delete!")) {
   window.location.href = "categories.php?c="+x;
  } else {
