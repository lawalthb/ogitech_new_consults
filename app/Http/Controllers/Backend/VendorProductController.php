...
class VendorProductController extends Controller
{
    ...
    public function VendorAddProduct()
    {
        ...
        return view('vendor.backend.product.vendor_product_add', compact('brands', 'categories', 'last_product_code'));
    } // End Method
    ...
    public function VendorBinCard($id)
    {

        $product_name = Product::where('id', $id)->value('product_name');
        $stocks = Stock::where('item_id', $id)->orderBy('id', 'ASC')->get();
        return view('backend.product.bincard_vendor', compact('stocks', 'product_name'));
    } // End Method

    public function VendorStatement($id)
    {

        $username = User::where('id', $id)->value('name');

        $statements = Statement::with('user')->where('user_id', $id)->get();
        return view('vendor.backend.orders.statement_vendor', compact('statements',   'username'));
    } // End Method
