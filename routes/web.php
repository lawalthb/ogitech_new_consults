...
//Route::get('/' , function(){
// echo "Your treats have now been escalated to very necessary government agencies.
//I advice you revert back to the gentle man I knew you to be from the beginning";
//});
...
Route::middleware(['auth', 'role:vendor'])->group(function () {
    ...
    Route::controller(VendorProductController::class)->group(function () {
        ...
        Route::get('/vendor/stock/card/{id}', 'VendorBinCard')->name('vendor.bincard.stock');
        Route::get('/vendor/statement/{id}', 'VendorStatement')->name('vendor.statement');
...
Route::middleware(['auth', 'role:admin'])->group(function () {
    ...
    Route::controller(BrandController::class)->group(function () {
        Route::get('/all/type', 'AllBrand')->name('all.brand');
        Route::get('/add/type', 'AddBrand')->name('add.brand');
        Route::post('/store/type', 'StoreBrand')->name('store.brand');
        Route::get('/edit/type/{id}', 'EditBrand')->name('edit.brand');
        Route::post('/update/type', 'UpdateBrand')->name('update.brand');
        Route::get('/delete/type/{id}', 'DeleteBrand')->name('delete.brand');
    });
    ...
    Route::controller(AdminController::class)->group(function () {
        ...
        Route::post('/add/vendor', 'StoreVendor')->name('add.vendor.store');
    ...
    Route::controller(ProductController::class)->group(function () {
        ...
        Route::get('/product/addstock', 'AddProductStock')->name('product.add.stock');
        Route::get('/product/bincard/{id}', 'AdminBinCard')->name('product.bincard.stock');
    });
    ...
    Route::controller(OrderController::class)->group(function () {
        ...
        Route::get('/admin/all/payment', 'AllPayment')->name('admin.all.payment');
        Route::get('/admin/make_payment', 'MakePayment')->name('admin.make.payment');
        Route::post('/admin/make_payment', 'StorePayment')->name('admin.payment.store');
        Route::get('/delete/make_payment/{id}', 'DeletePayment')->name('admin.payment.delete');

        Route::get('/admin/all/income', 'AllIncome')->name('admin.all.income');
        Route::get('/admin/make_income', 'MakeIncome')->name('admin.make.income');
        Route::post('/admin/make_income', 'StoreIncome')->name('admin.income.store');

        Route::get('/delete/make_income/{id}', 'DeleteIncome')->name('admin.income.delete');
    });
    ...
    Route::controller(ReportController::class)->group(function () {
        ...
        Route::get('/order/by/profit', 'OrderByProfit')->name('order.by.profit');
        Route::post('/search/by/user', 'SearchByUser')->name('search-by-user');
        Route::post('/search/by/vendor', 'SearchByVendor')->name('search-by-vendor');

        Route::get('/search/by/vendor', 'OrderByVendor')->name('order.by.vendor');
    });
    ...
    Route::controller(ActiveUserController::class)->group(function () {
        ...
        Route::post('/edit/user/{id}', 'UpdateUser')->name('update_user');
        Route::get('/all/vendor', 'AllVendor')->name('all-vendor');
        Route::get('/all/hoc', 'AllHoc')->name('all-hoc');
        Route::post('/all/hoc', 'StoreHoc')->name('admin.hoc.store');
        Route::get('/revoke/hoc/{id}', 'RevokeHoc')->name('revoke.hoc');

        Route::get('/add/make', 'AddHoc')->name('add-hoc');
    });
...
Route::middleware(['auth', 'role:user'])->group(function () {
    ...
    //     'Products'
    // )->name('products');
    // Route::get('/get_quote', 'Get_qoute')->name('get_quote');
